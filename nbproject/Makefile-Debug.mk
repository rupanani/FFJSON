...
${OBJECTDIR}/FFJSON.o: FFJSON.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/ferryfair -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FFJSON.o FFJSON.cpp
...
${TESTDIR}/tests/TestFFJSON.o: tests/TestFFJSON.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/ferryfair -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestFFJSON.o tests/TestFFJSON.cpp
...
${OBJECTDIR}/FFJSON_nomain.o: ${OBJECTDIR}/FFJSON.o FFJSON.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/local/include/ferryfair -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FFJSON_nomain.o FFJSON.cpp;\
	else  \
